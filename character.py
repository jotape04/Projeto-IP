...
class Alagoano(pygame.sprite.Sprite):
    ...
    def down(self):
        if (855 > self.rect.x > 300 and 300 > self.rect.y > 290):
            ...
            self.lock = 0
            return 0
        elif 235 > self.rect.x > 135 and 340 < self.rect.y < 350:
            self.jumpi = 0
            self.lock = 0
            return 0
            ...
            self.lock = 0
            return 0
        elif 890 > self.rect.x > 845 and 160 < self.rect.y < 204:
            self.jumpi = 0
            self.lock = 0
            return 0
            ...
            self.lock = 0
            return 0
        elif 755 > self.rect.x > 595 and 130 < self.rect.y < 140:
            self.jumpi = 0
            self.lock = 0
            return 0
